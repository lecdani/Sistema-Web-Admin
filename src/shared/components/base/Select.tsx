  ...
  ({ className = '', value, children, ...props }, ref) => {
    ...
    return (
      <div
        ...
        className={`relative flex w-full cursor-pointer select-none items-center rounded-md py-2 pl-8 pr-2 text-sm outline-none transition-colors hover:bg-blue-50 focus:bg-blue-50 ${isSelected ? 'bg-blue-50 text-blue-700 font-medium' : 'text-gray-700'} ${className}`}
        {...props}
      >
        {isSelected && (
