    ...
    try {
      ...
      const enrichedInvoices = invoicesData.map((invoice: Invoice) => {
        ...
        return {
          ...
          orderNumber: order?.po || 'PO no encontrado', // Corregido: usar po del pedido
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-gray-500">Administra todas las facturas del sistema</p>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <Card className="hover:shadow-md transition-all duration-200">
          <div className="p-4">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-xs font-medium text-gray-500">Pendientes de Pago</p>
        ...
        <Card className="hover:shadow-md transition-all duration-200">
          <div className="p-4">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-xs font-medium text-gray-500">Pagadas</p>
          ...
          <div className="flex flex-col lg:flex-row gap-4">
            <div className="flex-1">
              <div className="relative">
                ...
                <Input
                  placeholder="Buscar por factura, PO Number o tienda..."
                  value={searchTerm}
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Lista de todas las facturas registradas en el sistema
          </CardDescription>
        </CardHeader>
        <CardContent>
      ...
      <Dialog open={showInvoiceDetail} onOpenChange={setShowInvoiceDetail}>
        <DialogContent className="!w-[70vw] !max-w-[1200px] max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            <DialogTitle>Detalle de la Factura {selectedInvoice?.invoiceNumber}</DialogTitle>
            <DialogDescription>
          ...
          {selectedInvoice && (
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <Card>
                  ...
                  <CardContent className="space-y-3">
                    ...
                    <div className="flex justify-between">
                      <span className="text-gray-600">Tipo de Generación:</span>
                ...
                <Card>
                  ...
                  <CardContent className="space-y-3">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span>{selectedInvoice.items.length} items</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-gray-600">Cantidad Total:</span>
                      <span>{selectedInvoice.items.reduce((sum, item) => sum + item.quantity, 0)} unidades</span>
                    </div>
                  </CardContent>
                </Card>
              </div>
              ...
              <Card>
                <CardHeader>
                  <CardTitle className="text-lg">Productos Facturados</CardTitle>
                </CardHeader>
                <CardContent>
                  <div className="overflow-x-auto">
                    <Table>
